...
====================================================*/
	...
	/*invoices tablosunda ülkesi (BillingCountry) USA olmayan kayıtları 
	Total değerine göre AZALAN sırada listeleyiniz */ 
	...
	InvoiceId sırasına göre ARTAN sırada listeleyiniz */ 
	...
	/*===================================================
				IN OPERATOR
	====================================================*/
	/* customers tablosunda Belgium, USA, Norway veya  Canada  ülkelerinden sipariş veren
